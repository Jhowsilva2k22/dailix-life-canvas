...
const DashboardContent = () => {
  ...
  const summaryCards = [
    ...
    { icon: Flame, iconColor: "#F59E0B", label: "SEQUÊNCIA", value: "0", sub: "dias seguidos" },
    { icon: Target, iconColor: "#00B4D8", label: "META DO MÊS", value: goalText, isText: true, sub: "definida por você" },
    { icon: TrendingUp, iconColor: "#10B981", label: "MÓDULOS ATIVOS", value: String(modulesCount), sub: "áreas organizadas" },
  ];
  ...
  const gettingStartedCards = [
    ...
    { num: "02", title: "Crie um hábito", desc: "Consistência supera intensidade.", cta: "Criar hábito", action: () => {} },
    { num: "03", title: "Explore seu conteúdo", desc: "Vídeos selecionados para cada área da sua vida.", cta: "Ver conteúdo", action: () => {} },
  ];
      ...
      <div style={{ maxWidth: 1200 }} className="mx-auto px-4 md:px-8 pt-20 md:pt-8 pb-24 md:pb-10">
        ...
        <section className="mb-10" data-reveal style={{ transitionDelay: "160ms" }}>
          ...
          {todayTasks.length === 0 ? (
            <div
              ...
              style={{ background: "rgba(0,180,216,0.03)", border: "1px dashed rgba(0,180,216,0.2)", borderRadius: 12 }}
            >
              <p style={{ color: "#94A3B8", fontSize: 14, fontWeight: 300 }}>Nenhuma tarefa para hoje ainda.</p>
              <button
                onClick={() => setShowTaskModal(true)}
                className="inline-flex items-center gap-1.5 rounded-lg transition-colors mt-3"
            ...
            <div className="space-y-2">
              ...
              <button
                onClick={() => setShowTaskModal(true)}
                className="inline-flex items-center gap-1.5 rounded-lg transition-colors mt-2"
                style={{ color: "#00B4D8", fontSize: 13, fontWeight: 400, padding: "8px 16px" }}
              >
                <Plus size={16} />
                Adicionar tarefa
        ...
        <section className="mb-10" data-reveal style={{ transitionDelay: "240ms" }}>
          ...
          <div
            ...
            style={{ background: "rgba(0,180,216,0.03)", border: "1px dashed rgba(0,180,216,0.2)", borderRadius: 12 }}
          >
            <p style={{ color: "#94A3B8", fontSize: 14, fontWeight: 300 }}>Nenhum hábito configurado.</p>
            <button
              className="inline-flex items-center gap-1.5 rounded-lg transition-colors mt-3"
              style={{ color: "#00B4D8", fontSize: 13, fontWeight: 400, padding: "8px 16px" }}
            >
